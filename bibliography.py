...
BIBLIOGRAPHY_LASTUPDATE = '2022/01/24'
...
BIBLIOGRAPHY = (
    ...
    ('4', 'Primitive data structures for the 3SUM and k-SUM problem', '', 'Carolin Zöbelein', '', '2021', 'Preprint', '', '', 'Math, CS', '', '', '', '', '', 'paper_0002.pdf', 'Notes: A 3SUM algorithm on the binary addition level of atomic generated real numbers (<a href="https://github.com/Samdney/notes-3sum/blob/master/notes-3sum.pdf"  title="External: Notes: A 3SUM algorithm on the binary addition level of atomic generated real numbers"" target="_blank">pdf</a>)', '', '', 'paper_0002',
    ...
    ('3', 'BlueTransience', 'A Bluetooth based, short memory, social media mobile network app', 'Carolin Zöbelein', 'March 26, 2021', '2020', 'Proposal', ' Bluetooth, Mobile App, Social Media, Natural Disaster, Political Demonstrations, Internet Shutdown', '', 'CS', ' Authorea', 'https://www.authorea.com/users/402885/articles/515244-proposal-bluetransience', '', 'https://github.com/Samdney/proposal-bluetransience', '', 'proposal_0001.pdf', '', '', 'https://doi.org/10.22541/au.161676845.56300213/v1', 'proposal_0001', 
